...
/*
所以说本文将的作用是实现service provider接口。具体做的事情会在他的service。go中定义
*/
import (
	"fmt"
...
//  下面实现service provider的接口。
//我们要实现的是一个service provider，根据接口协议，即ServiceProvider接口,
//我们需要实现几个方法：Nam，Register等
//这就是接口的好处，我们需要服务，只要新建结构体，符合接口协议，就可以初测进去了
